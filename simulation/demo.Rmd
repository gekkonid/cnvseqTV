...
```{r}
cnv_plot(wg, hit, zoom_chrom="chr01", zoom_start=0.5e6, zoom_end=2.5e6, log2fc_thresh = 0.6) + ggplot2::ylim(-10, 10)
```

```{r}
cnv_plot(wg, hit, zoom_chrom="chr01", zoom_start=3.5e6, zoom_end=5.5e6, log2fc_thresh = 0.6) 
```
